...
/*! @name PIO1_9 (number 10), RES_
  @{ */
#define BOARD_INITPINS_RES__GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_RES__PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_INITPINS_RES__PIN 9U    /*!<@brief 1U pin index: 9 */
                                      /* @} */

/*! @name PIO1_10 (number 40), A0
  @{ */
#define BOARD_INITPINS_A0_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_A0_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_INITPINS_A0_PIN 10U   /*!<@brief 1U pin index: 10 */
                                    /* @} */
